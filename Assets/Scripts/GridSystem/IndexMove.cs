...
public static class IndexMove
{
	...
	//Index hareket edebilir mi hareket edebilirse eşleşme var mı onun kontrolünü yapıyor.
	public static void CheckStatus(MoveType _moveType, int _index1)
	{
		...
		{
			Debug.Log("HAMLEDE EŞLEŞME VAR!");
			UIController.instance.SetMatchImage(true);
		}
		else
		{ 
			Debug.Log("HAMLEDE EŞLEŞME YOK!");
	...
	//Eşleştirme veya hareketi yapacakken sıradaki indexi hesaplatma
